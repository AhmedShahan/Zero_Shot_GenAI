'''
This is noting but our sequencial Chain making project as like
squencial Chain
'''
'''
...
chain=RunnableSequence(prompt1,model1,parser,prompt2,model2,parser,prompt3,model3,parser,prompt4,model2,parser)

chain.get_graph().print_ascii()
result = chain.invoke({"topic": topic})
print("Blog Post:", result)

######### Output will be always last parser output
