...
Message_Content=[
    ...
    ('human', "Analyze the feedback and return the Positive or Negative Feedback for the following content {content} and feedback. Please Return The result either Positive or Negative. Do not return any other information. Just return the result as Positive or Negative. If the feedback is not clear, return 'Unclear'.")
]
