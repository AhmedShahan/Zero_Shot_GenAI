### What I will try
'''
basic chat prompt templet which will be used for extraction role
prompt
...
message=[
    ("system", "Extract structured information about the phone review."),
    ("human", "{review}")
]
from langchain.prompts import ChatPromptTemplate
prompt_templet=ChatPromptTemplate.from_messages(message)
