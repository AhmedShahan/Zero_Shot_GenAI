...
# Step 3: Create Annoy vector store
vectorstore = Annoy.from_documents(docs, embedding)

# Step 4: Save the index to disk (optional)
vectorstore.save_local("/home/shahanahmed/Zero_Shot_GenAI/RAG/3_vector_store/2_Annoy")

# Step 5: Load the index back later
# loaded_vectorstore = Annoy.load_local("annoy_index", embedding)
